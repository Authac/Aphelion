...
class Template {
	...
	public function __construct() {
		...
		$this->_vars['template_dir'] = $_SERVER['DOCUMENT_ROOT']  . '/template';
		$this->_vars['js_template_dir'] = $_SERVER['DOCUMENT_ROOT']  . '/template/js';
		$this->_vars['css_template_dir'] = $_SERVER['DOCUMENT_ROOT']  . '/template/css';
	}
